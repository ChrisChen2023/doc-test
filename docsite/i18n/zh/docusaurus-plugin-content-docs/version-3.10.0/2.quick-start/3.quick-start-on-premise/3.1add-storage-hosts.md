...
首次连接到 <ProductName_CN /> 后，需要先添加 Storage 主机，并确认主机都处于在线状态。

<!--
:::compatibility 历史版本兼容性

- 从 <ProductName_CN /> 3.0.0 版本开始，必须先使用`ADD HOSTS`添加主机，才能正常通过 Storage 服务读写数据。
- 在 <ProductName_CN /> 3.0.0 之前的版本和 NebulaGraph Cloud 中，无需执行该操作。
:::
-->
...
已[连接 <ProductName_CN /> 服务](3.connect-to-nebula-graph.md)。
