...
本文以一个示例说明如何使用 Exchange 将存储在 HDFS 或本地的 CSV 文件数据导入 <ProductName /> 。
...
2. 使用 <ProductName /> Console 创建一个图空间** basketballplayer**，并创建一个 Schema，如下所示。
...
运行如下命令将 CSV 文件数据导入到 <ProductName /> 中。关于参数的说明，请参见[导入命令参数](../parameter-reference/ex-ug-para-import-command.md)。
