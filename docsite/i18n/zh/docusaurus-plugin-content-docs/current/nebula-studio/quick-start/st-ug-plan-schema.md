...
在使用 Studio 之前，用户需要先根据 <ProductName_CN /> 的要求规划 Schema（模式）。
...
用户可以下载 <ProductName_CN /> 示例数据集 [basketballplayer](https://docs-cdn.nebula-graph.com.cn/dataset/dataset.zip "点击下载") ，本文将通过该示例说明如何规划 Schema。
