...
本文简单说明如何使用 Exchange 将存储在 Kafka 上的数据导入 <ProductName /> 。
...
运行如下命令将 Kafka 数据导入到 <ProductName /> 中。关于参数的说明，请参见[导入命令参数](../parameter-reference/ex-ug-para-import-command.md)。
...
- JAR 包需要从[<ProductName />套餐](https://nebula-graph.com.cn/pricing/)中获取。
