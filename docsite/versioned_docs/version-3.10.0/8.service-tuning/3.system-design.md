...
Vertical scaling usually has higher hardware costs, but relatively simple operations. NebulaGraph <Var name="nebula_release" /> can also be scaled vertically.
-->
