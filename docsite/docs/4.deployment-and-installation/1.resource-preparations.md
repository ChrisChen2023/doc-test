...
- RAID is not recommended because <ProductName /> provides a multi-replica mechanism. Configuring RAID would result in a waste of resources.
...
We do not recommend you deploy <ProductName /> on Docker Desktop for Windows due to its subpar performance. For details, see [#12401](https://github.com/docker/for-win/issues/12401). 
