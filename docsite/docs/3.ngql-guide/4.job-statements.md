...
The `SUBMIT JOB DOWNLOAD HDFS` and `SUBMIT JOB INGEST` commands are used to import the SST file into NebulaGraph. For detail, see [Import data from SST files](../import-export/nebula-exchange/use-exchange/ex-ug-import-from-sst.md).
